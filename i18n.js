...
window.HBT_I18N = {
  ...
  fr: {
    ...
    'showroom.empty.title':   'Le showroom prend vie bientôt',
    'showroom.empty.text':    'Nos photos arrivent sous peu. En attendant, nous vous invitons à découvrir l\'espace de visu en prenant rendez-vous.',
    'showroom.empty.cta':     'Demander une visite',
  ...
  en: {
    ...
    'showroom.empty.title':   'The showroom is coming to life soon',
    'showroom.empty.text':    'Our photos are coming shortly. In the meantime, we invite you to discover the space in person by booking a visit.',
    'showroom.empty.cta':     'Book a visit',
  ...
  es: {
    ...
    'showroom.empty.title':   'El showroom cobra vida pronto',
    'showroom.empty.text':    'Nuestras fotos llegan pronto. Mientras tanto, le invitamos a descubrir el espacio en persona reservando una visita.',
    'showroom.empty.cta':     'Reservar una visita',
